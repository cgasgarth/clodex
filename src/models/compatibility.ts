// src/models/compatibility.ts — curated blacklist + models.dev capability filtering
...
// SAFETY: The imported JSON is repository-owned and follows IncompatibleModelFile.
